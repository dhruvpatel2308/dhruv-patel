...
namespace dhruv1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ItemDataTable : global::System.Data.TypedTableBase<ItemRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemRow AddItemRow(int Id, string Item_name, decimal Price) {
...
namespace dhruv1.Database1DataSetTableAdapters {
    ...
    public partial class ItemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Item] WHERE (([Id] = @Original_Id) AND ((@IsNull_Price = 1 AND" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Item] ([Id], [Item_name], [Price]) VALUES (@Id, @Item_name, @P" +
                "rice);\r\nSELECT Id, Item_name, Price FROM Item WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Item] SET [Id] = @Id, [Item_name] = @Item_name, [Price] = @Price WH" +
                "ERE (([Id] = @Original_Id) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Pri" +
                "ce] = @Original_Price)));\r\nSELECT Id, Item_name, Price FROM Item WHERE (Id = @Id" +
                ")";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dhruv1.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Item_name, Price FROM dbo.Item";
        ...
        public virtual int Insert(int Id, string Item_name, global::System.Nullable<decimal> Price) {
        ...
        public virtual int Update(int Id, string Item_name, global::System.Nullable<decimal> Price, int Original_Id, global::System.Nullable<decimal> Original_Price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Item_name, global::System.Nullable<decimal> Price, int Original_Id, global::System.Nullable<decimal> Original_Price) {
            return this.Update(Original_Id, Item_name, Price, Original_Id, Original_Price);
        }
    }
